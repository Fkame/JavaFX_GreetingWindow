...
public class TestGreetingWindowShow extends Application implements IJavaFxTest
{
    private Stage stage;
    ...
    public void launchJavaFXThread() {
        ...
        javafxThread = new Thread(() -> TestGreetingWindowShow.launch());
        javafxThread.start();
    }
